...
## 업데이트 백로그 (참고)
- 커리큘럼 저작에 영향을 주는 계획된 구조 개선은 `_design_docs/05_update_backlog/` 에 있다(예: 01=시각자료를 이론/연습 섹션에도 배치 + 커리큘럼 소개 `intro` 필드, 03=조표·다현). 착수된 항목이 저작 규약(섹션 구성·meta 필드)을 바꾸면 해당 md 를 따르고 status 를 확인한다. `README.md` 가 인덱스.
