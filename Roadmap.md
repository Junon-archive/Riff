...
> 최종 갱신: 2026-07-09 · **라이브: https://guitar-riff.pages.dev**
...
| **커리큘럼 콘텐츠** | ✅ 완료 | `solo_scale_3months` **52일** + `chord_building_2months` **32일** + `funk_rhythm_2months` **32일** = **116 Day**, 전량 KR/EN/JP |
...
### 🟨 다음 후보 (신규 개발)
- **📁 업데이트 백로그 — `_design_docs/05_update_backlog/`** — 미래 렌더러/구조 개선을 작업 묶음별 상세 설계로 문서화(01 시각자료 배치+소개 / 02 표현기법 밴딩·해머링·붙임줄·잇단음·비4/4 / 03 악보 음정 정확성 조표·튜닝·다현 / 04 슬래시 리듬 / 05 태그 필터). 각 md에 관련 코드 위치·수정 상세·기존 불변 보장·검증 게이트·체크리스트·status. 착수 시 해당 문서 따라 진행하고 status 갱신. **README.md가 인덱스.**
