...
> 최종 갱신: 2026-07-10 · **라이브: https://guitar-riff.pages.dev**
...
| **커리큘럼 콘텐츠** | ✅ 5트랙 라이브 / 🟡 6종 확장중 | solo 52 + chord 32 + funk 32 + 입문일렉 16 + **입문베이스 16** = **148 Day**(5트랙), 전량 KR/EN/JP. 신규 6종(블루스·네오소울·슬랩·셔플바운스·워킹 등) 설계·프롬프트 진행(백로그 11~16) |
