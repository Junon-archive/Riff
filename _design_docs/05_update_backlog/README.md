...
| 02 | [표현 기법(밴딩·해머링·붙임줄·잇단음·비4/4)](02_expressive-techniques.md) | 🔴 TODO | 중간 | 중간 | 없음 |
| 03 | [악보 음정 정확성(조표·튜닝·다현)](03_notation-accuracy.md) | 🟡 IN_PROGRESS (②③ 완료: 튜닝+다현/지판 · ① 조표 대기) | 중간 | 높음 | 없음(내부 순서 있음) |
