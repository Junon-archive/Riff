...
|---|---|---|---|---|---|
| 20 | [메트로놈 + Functions 공통 셸](05-1_add_new_function/20_metronome.md) | 🔴 TODO (**설계 확정 완료** 2026-07-24 · 구현 대기 · Functions 1호·먼저 배포) | 높음 | 중간 | 없음 |
| 21 | [배킹 트랙 (기타/베이스 분리·Suno Pro 음원)](05-1_add_new_function/21_backing.md) | 🔴 TODO (**설계 확정 완료** 2026-07-24 · 구현 대기 · 메트로놈 후속) | 높음 | 중간 | 20 |
