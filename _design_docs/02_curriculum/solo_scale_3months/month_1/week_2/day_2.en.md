...
Here's why we're doing this today. Yesterday, while building the Box 1↔2 bridge, you probably felt it: "oh, the fretboard really does connect room by room." But two boxes still only cover about half the neck. Today we're climbing one more level, up to **Box 3 (frets 9–13).** Once this box feels familiar, your playground stretches all the way to the middle of the neck (around fret 12).
...
Here's today's connecting line. You run up through Box 2, then **slide the 2nd string's A (fret 10) up to fret 13**, entering Box 3. The landing note — C (the ♭3)! At the end, you land back on that C inside Box 3 and sing it out with vibrato.
