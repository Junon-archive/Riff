...
今日なぜこれをやるかというと、これから毎朝スイッチが入る**「手のエンジンをかけるルーティン」**を、今日完成させておきたいからです。即興ソロはアイデア勝負ですが、どんなにアイデアが良くても、手がついてこなければ頭の中のメロディは指先で崩れてしまいます。だから私たちは、毎日の最初の10分間を**決まった予熱セット**で始めます。今日、そのセットを体に刻み込みます。

今日押さえるのは二つだけ。**オルタネイトピッキング**と**フィンガー独立**です。
...
大事な感覚はこれです。**「アップピッキングもダウンピッキングと同じくらい大きく、はっきりと。」**多くの人は、アップがダウンより小さく、遠慮がちになってしまいます。今日はむしろアップを少し大げさに弾いてみてください。

### 2) フィンガー独立＝使っていない指も待機状態に

フィンガー独立とは、「一本の指を動かしたとき、他の指が一緒についてこないこと」です。特に3の指（薬指）と4の指（小指）は神経がほぼつながっているようなもので、薬指を上げると小指もぴょこんとついてきてしまいます。これが、即興のときに「弾きたい音に指が遅れて到着する」原因の9割を占めています。

解決策として有名なのが**スパイダーウォーク（クロマチック1–2–3–4）**です。1フレットに1本ずつ指を割り当てて、**押さえている指はそのまま押さえたまま**、次の指を下ろすのがポイントです。地味ですが、これを2週間毎日続けるだけで、手がまるで別人の手のようになります。
...
このセットは、これから**毎日繰り返すウォームアップの原型**になります。今日、この順番を体に覚えさせましょう。

**0〜10分・ウォームアップ（BPM 60 → 少しずつ上げる）**
- 上の(a)スパイダーウォーク1-2-3-4を6弦→1弦まで、そしてまた1弦→6弦へ戻りながら往復。
- ルール：**押さえている指は、次の音まで離さない。**オルタネイトピッキングのダウン–アップも厳守。
...
- **鏡チェック：**薬指を押さえるとき、小指が指板から浮いていないか目で確認します。小指は常に指板から1cm以内で待機。
- 完了の目安：小指が跳ね上がらずに1小節を弾き切れる。

**20〜40分・実戦感覚（BPM 75、Amバッキング）— 二音即興**
- 昨日は一音でした。今日は**二音（A根音＋C、つまり♭3）**に増やします。1弦5フレット（A）と8フレット（C）だけを行き来しながらリズム遊び。
- ちょっとした先取り：**コードが鳴っているときにC（8フレット）で止まってみてください。**「あれ、なんかしっくりくる」というあの感覚——それが3度着地の予告編です。
