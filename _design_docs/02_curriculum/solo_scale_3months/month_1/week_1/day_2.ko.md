...
오늘 왜 이걸 하냐면요. 어제 4연음으로 관성을 좀 깼잖아요? 근데 4연음도 결국 "옆 음, 옆 음, 옆 음"으로 붙어서 움직이는 거라, 소리가 아직 계단처럼 밋밋해요. 진짜 솔로 느낌, 그러니까 "노래하는" 느낌은 음과 음 사이가 **폴짝 뛸 때** 나와요. 그게 바로 3도 인터벌이에요.

3도 인터벌은 별거 아니에요. 스케일에서 **바로 옆 음을 건너뛰고 그 다음 음으로 점프**하는 거예요. A 다음에 C가 아니라 그 다음 D로, C 다음엔 E로. "한 칸 건너뛰기" 게임이라고 생각하세요. 이렇게 하면 같은 5음 펜타토닉인데도 소리가 갑자기 세련돼져요. B.B. King이든 슬래시든, 귀에 꽂히는 리크는 대부분 이 3도 점프가 씨앗이에요.

그리고 여기 숨은 보너스가 있어요. 3도로 뛰다 보면 자연스럽게 **A→C, D→F#(는 없고)…** 아니, 우리 스케일 안에서는 A에서 뛰면 D, C에서 뛰면 E인데, 이 점프들의 착지점에 계속 **C(♭3)와 A(근음)**가 걸려요. 즉 3도 훈련은 그 자체로 "타겟음에 착지하는" 감각을 몰래 심어줘요. 어제 눈도장 찍은 C, 오늘은 손끝으로 몸이 기억하게 만들 거예요.
...
오늘의 본체, 3도 인터벌 상행 시퀀스예요. 두 음씩(8분음표) 폴짝폴짝 뛰어 올라가요. 착지점 C·A에 강조가 걸린 거 보이시죠?
...
**0~10분 · 워밍업 (BPM 65)**
먼저 어제 4연음 시퀀스로 2분만 손을 풀고, 곧바로 3도 인터벌 상행으로 넘어가요. 8분음표 두 개가 "폴-짝" 한 세트. 처음엔 손가락이 꼬일 거예요. 정상이에요. 클릭에 정확히 붙는 것보다 **점프 자체가 안 끊기는 것**을 먼저.

**10~20분 · 두뇌 훈련 (오늘의 타겟 = C·A / ♭3·근음)**
3도로 뛸 때마다 착지음 이름을 소리 내서 불러요. "에이-디, 씨-이, 디-지…" 이렇게요. 특히 착지가 C나 A일 때는 목소리를 한 톤 올려서 강조. 손과 입과 귀를 동기화시키는 게 오늘의 진짜 목적이에요.

**20~40분 · 실전 즉흥 (Am 원코드 백킹 / 65~70 BPM)**
백킹을 틀고 규칙: **오늘은 두 음 이상 붙여 치지 말고, 무조건 3도로만 뛰어다니기.** 답답하죠? 그 제약이 손을 새 길로 몰아넣어요. 그리고 프레이즈를 끝낼 땐 반드시 C(♭3)에 착지해서 멈춰보세요. 그 "탁 걸리는" 느낌을 기억하세요 — 그게 코드톤 착지의 첫 경험이에요.

**40~50분 · 녹음/피드백 (권장)**
30초 녹음 후 재생. 체크 포인트: 점프 착지음이 **음정이 흔들리지 않고 딱 짚였는지**. 스킵할 때 중간 현을 살짝 건드려 "치익" 잡음이 나면, 피킹 안 하는 현을 오른손 바닥으로 살짝 뮤트하는 습관을 들여요.
