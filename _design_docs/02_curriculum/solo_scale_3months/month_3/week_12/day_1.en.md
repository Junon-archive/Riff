...
Here's why we're doing this today. This is finally the last week. Over the past 11 weeks, we've really built up a lot — connecting the five pentatonic boxes, learning the blues ♭5 with bending and vibrato, chord-tone targeting, ii-V-I guide tones, the Dorian major 6th, the Mixolydian ♭7, and mode-switching across genres. But all of that has just been **scattered parts floating around in your head.** This week, we're gathering those parts into **one original solo, entirely yours.** Not a cover — a solo you actually composed.

Know what the most common mistake is when writing a real piece? **Starting by playing notes first.** Stack bricks without a blueprint and the house collapses. So today includes some time with the instrument set aside. First we lock in the **skeleton (chord progression)**, then draw a **map of where to land** on top of it.

Here's our song's progression. A as the center, eight bars, short and solid.

**Am7 | D7 | Am7 | D7 | A7 | D7 | Am7 | Am7**

Why build it this way? Because this progression has **Dorian and Mixolydian living inside it at the same time.** Let's look at it one piece at a time.

- **Am7 → the 3rd is C (♭3).** A minor color, centered on A. This is Dorian's home turf.
- **D7 → the 3rd is F#.** And surprisingly, this F# is **A's major 6th (♮6).** That's the sophisticated Dorian color tone we learned back in Week 9! Which means the instant you land on D7, the Dorian color kicks in automatically. Free bonus.
...
Here's the core of it. **C (♭3) and C# (major 3rd) sit just one fret apart on the 3rd string (fret 5 → fret 6).** That one fret is the Dorian ↔ Mixolydian switch. Nudge one finger and the whole expression of the song changes. Today, you'll get comfortable with a **map that gathers every landing point — switch included — into one hand position.**

## ② Visual Reference

First, **today's key landing map.** All the 3rds you need to aim for when the chord changes are gathered here — C (Am7 landing · ♭3), F# (D7 landing = A's major 6th color), C# (A7 landing · major 3rd), and even the ♭7 color tone G. Get familiar with just the highlighted dots and you're already halfway through this week.
...
Second, the **"one home" position** where these landing points live. It's a combined fretboard overlaying A Dorian and A Mixolydian in one spot (frets 5-9). See how C (♭3) and C# (major 3rd) sit right next to each other on the 3rd string? Master this one spot and your hand won't wander for all eight bars.
...
With whatever recording tool you've got (a voice memo app works great), save just the last 30 seconds of your jam. Listen back and check one thing only: **was I on the 3rd the instant the chord changed?** If you were off, just note which chord you were late on. We'll fix that all week.
