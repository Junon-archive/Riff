...
Here's why we're doing this today. Over the last 8 weeks, you've gotten comfortable with minor, chord tones, and guide tones. But have your solos been stuck circling around "dark minor" the whole time? Sad, heavy, always the same color. Starting today, we change that color. With just **one note**.
...
- **A Dorian**: A B C D E **F#** G → the 6th note is **F# (major 6th, ♮6)**
...
Second, here's a short line for comparing Aeolian vs. Dorian by ear. Both bars go 5th (E) → the 6th note → 5th (E) → root (A) — identical except for that one 6th-scale-degree note. Bar 1 has **F (b6, dark)**, bar 2 has **F# (♮6, bright)**. Listen to how a single fret's difference (fret 8 vs. fret 9) completely changes the color.
