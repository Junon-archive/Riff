...
첫째, **A 믹솔리디안 Position 2**예요. 근음 A는 4번 줄 7프렛. 여기서도 장3도 C#(빨강)과 ♭7 G(빨강)의 위치를 눈에 익히세요. Position 1과 음이름은 같고 모양만 달라요.
...
둘째, 두 폼을 잇는 **연결 지도**예요. Position 1과 Position 2의 근음(A), 장3도 C#(빨강), ♭7 G(빨강)를 넥 위에 함께 뿌렸어요. 4번 줄 7프렛 근음은 두 폼이 공유하는 '연결 고리'예요. 그리고 1번 줄 5프렛(A) → 9프렛(C#) 슬라이드가 오늘의 이동 경로예요.
