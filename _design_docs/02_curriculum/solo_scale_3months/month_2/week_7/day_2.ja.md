...
今日の主役は3度の**E**です。昨日Cが Am を「マイナーらしく」したように、EはCを「メジャーらしく」明るくしてくれる音です。だからEを着地ターゲットとして赤くマークしておきます。ちなみにこのEは、昨日Amで5度だったのと同じ音です。同じフレットでも、コードが変われば役割が変わる——この感覚を今日は体で味わってみてください。

改めて強調しますが、これは速弾きではありません。**位置を認識する頭のトレーニング**です。遅いBPMで「ここもE、あそこもE」とはっきり地図を描く、それだけです。

## ② 視覚資料

Cコードトーン（C・E・G）をネック全体（0〜12フレット）にマッピングしました。赤くハイライトされているのが3度の**E**、今日の着地ターゲットです。
