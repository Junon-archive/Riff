---
title: "The challenge begins — eight weeks' arsenal onto one track"
dayKey: "m2.w8.d1"
estMinutes: 50
i18nKey: "lesson.m2.w8.d1"
---

# Day 1 — This week isn't for learning, it's a stage
...
▶ **BPM 78.** Over the track 4×. Feel whether the cutting's crisp shimmer suits the track.

**Card B — single-note riff (2 bars).** A single-note line on the 5th/4th strings. A 'riff'-like part locking with the bass.
...
▶ **BPM 78.** Over the track 4×. Feel the line converse with the bass. Compare with Card A.
...
- **Sticking to one card.** Experimenting with both makes the tune richer. Cutting for the verse, a line for the hook.
- **Not listening to the track.** Without hearing the backing your groove floats. Hear the bass and drums first.
- **Perfectionism.** Today is experimentation. Just set a direction. Completion is all week.
- **Greed for speed.** If 78 is fast, go slower. Locking first, speed later.
