...
昨日は1弦でラインを描きました。今日は**5弦と4弦、2弦をまたぐ**ラインです。2弦が開くと、ラインがずっと広く歌います。

核心の難関はこれ。ラインが5弦から4弦へ移るとき、**たった今弾いた5弦を素早く殺し、4弦だけ鳴らす**必要があります。でないと2音が重なって汚れます。指が新しい弦へ移りながら、同時にたった今弾いた弦を片づける感覚 — これがシングルノート・ラインの本当の技術です。左手は常に「今鳴らす1弦」だけを開け、残りは全部覆います。
...
5・4弦の2弦をまたぐラインです。弦を変えるとき前の弦を殺すのが核心。マップで音の位置を再確認します。
...
**0〜10分 · ウォームアップ**
BPM 60〜70。5弦↔4弦を交互に弾き、弦を変えるとき前の弦が死ぬか点検。残りの弦のミュートも維持。

**10〜20分 · 頭のトレーニング（今日のターゲット＝弦の切替＋ミュート）**
マップで5・4弦の音を刻む。指が新しい弦へ移りながら前の弦を覆う動作をゆっくり反復。

**20〜40分 · 実戦グルーヴ（例1・2 / BPM 72）**
**例1**（2弦のライン）をBPM 72で4回 → **例2**（クロス・リフ）へ。弦の切替で後ろがきれいなのが核心。

**40〜50分 · 録音・セルフフィードバック（推奨）**
録音してチェック：弦を変えるとき前の音が残らないか／ラインははっきりつながるか／他の弦の雑音はないか。
