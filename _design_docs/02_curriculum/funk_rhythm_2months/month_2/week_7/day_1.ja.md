...
同じリズム、同じ音でも、その音を**きっちり切るか、ずっと伸ばすか**でまったく違うグルーヴになります。ファンクのあの締まったタイトな味は、まさに**スタッカート**から生まれます。

スタッカートは、音を弾いた直後に手を弦にそっと乗せて**余韻をきっちり切る**技術です。短い音の直後にすぐ沈黙が来る。逆に**レガート**は音を最後まで伸ばして余韻を残すこと。たとえるなら、スタッカートは点を打つこと、レガートは線を引くこと。同じ音をスタッカートで弾くとリズムがぴんと締まり、レガートで弾くとゆるく開きます。
...
同じ4回の打撃をレガート（長く）とスタッカート（短く＋沈黙）で比較します。音の長さが印象を変えます。
...
**0〜10分 · ウォームアップ**
BPM 60〜70。1音を長く（レガート）／短く（スタッカート）交互に出して切るタイミングをウォームアップ。

**10〜20分 · 頭のトレーニング（今日のターゲット＝切る）**
口でレガートは「ダーー」、スタッカートは「ダッ！」と声に出して長さを区別。いつ切るか先に描きます。

**20〜40分 · 実戦グルーヴ（例1・2 / BPM 70）**
**例1**（レガート）と**例2**（スタッカート）をBPM 70で交互に4回ずつ。同じパターンがどれだけ違って聞こえるかが核心。

**40〜50分 · 録音・セルフフィードバック（推奨）**
録音してチェック：スタッカートは短く切れるか／レガートは最後まで鳴るか／2つの違いははっきりか。
