---
title: "Completing the staccato + shuffle groove"
dayKey: "m2.w7.d4"
estMinutes: 50
i18nKey: "lesson.m2.w7.d4"
---

# Day 4 — Complete expression through length and sway
...
▶ **BPM 76.** Over a backing 4×+. Feel the staccato tighten the rhythm.

**Example 2 — shuffle-feel groove (2 bars).** The same material swayed long-short (shuffle). A bouncing groove.
...
▶ **BPM 76.** The notation is straight, but swing it, 4×. Once easy, mix staccato and shuffle into your own groove and record.
...
- **Length/sway flat.** Weak staccato/shuffle kills the expression. Cut clearly, sway clearly.
- **Shuffle goes straight.** Minding the tightening, you lose the sway. Keep rolling "daa-dm."
- **Too complex.** Cramming in every tool gets cluttered. One or two expressions, clear.
- **Without a backing.** Expression lives alongside other instruments. Always over a track.
