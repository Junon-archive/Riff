...
Now that the even ghost carpet is down, today you **drop real notes onto it** to make a true groove. Onto yesterday's "chick-chick," deciding which spots get a clear "ta" is the whole of today.
...
Today's sound material — a high stab on the 3rd and 2nd strings. From this one spot, left-hand pressure alone moves between 'ta' (real) and 'chick' (ghost).
...
**0–10 min · Warm-up**
BPM 60–70. Over yesterday's ghost carpet, drop a single "ta" anywhere to warm up the pressure on/off.

**10–20 min · Brain training (today's target = placing "ta")**
Count "ta-chick-chick-ta," pinpointing today's "ta" spots. Picture which 16ths carry the real note.

**20–40 min · Real groove (Examples 1·2 / BPM 68)**
Repeat **Example 1** (mix) 4× at BPM 68 → then **Example 2** (pushed groove). Once easy, shift the "ta" spots to vary it. Ration the real notes.

**40–50 min · Record & reflect (recommended)**
Record and check: is the ta/chick contrast clear / is the timing of real notes accurate / is the ghost background clean?
