...
모터가 돌기 시작했으니, 오늘은 그 모터를 **고르게** 만들어요. 핵심은 두 가지 — 다운과 업의 밸런스, 그리고 '빈 피킹'이에요.

대부분 다운스트로크는 세고 또렷한데 업스트로크는 약하고 흐릿해요. 그러면 16비트가 '쿵-작-쿵-작'처럼 절뚝거려요. 좋은 펑크는 다운과 업의 **음량과 타이밍이 쌍둥이처럼 균일**해요. 눈을 감고 다운만, 업만 따로 쳐 보며 둘의 크기를 맞춰 보세요.
...
'칠 자리'와 '빈 자리'를 눈으로 구분해요. 아래 악보에서 음표는 실제로 스치는 자리, 쉼표는 손은 움직이지만 줄은 안 치는 빈 피킹 자리예요.
...
**0~10분 · 워밍업**
BPM 60~70. 다운만 16번, 업만 16번 따로 쳐보며 둘의 음량을 맞춰요. 그다음 다운-업 번갈아.

**10~20분 · 두뇌 훈련 (오늘의 타겟 = 빈 피킹)**
손은 16비트로 계속 흔들되, 입으로 '칠 자리'만 세요(예: "1...&..."). 손은 안 멈추고 소리만 골라내는 감각을 익힙니다.

**20~40분 · 실전 그루브 (예제 1·2 / BPM 68)**
**예제 1**(박에만 치기)을 BPM 68에서 4번 → **예제 2**(박과 앤)로. 쉼표 자리에서도 손이 흔들리는지가 관건.

**40~50분 · 녹음/셀프 피드백 (권장)**
녹음 후 체크: 소리 낸 자리의 타이밍이 정확한가 / 빈 자리에서 손이 멈추지 않았는가 / 다운·업 음량이 균일한가.
