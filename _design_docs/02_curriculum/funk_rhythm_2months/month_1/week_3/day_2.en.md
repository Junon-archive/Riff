...
**0–10 min · Warm-up**
BPM 60–70. Review yesterday's '&' accent, then warm up shifting the accent to the 'e' and the 'a.'

**10–20 min · Brain training (today's target = moving the accent)**
Count "chick-POP-chick-chick" (e) and "chick-chick-chick-POP" (a) alternately. Pinpoint exactly which piece carries the accent.

**20–40 min · Real groove (Examples 1·2 / BPM 68)**
Repeat **Example 1** ('e' accent) 4× at BPM 68 → then **Example 2** ('a' accent). Alternate the two versions to feel the difference.

**40–50 min · Record & reflect (recommended)**
Record and check: does the accent land exactly on e/a / do the two versions groove differently / is the rest soft?
