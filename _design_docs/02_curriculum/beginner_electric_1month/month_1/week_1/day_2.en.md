---
title: "Left hand, first steps — one finger one fret, chromatic 1-2-3-4"
dayKey: "m1.w1.d2"
estMinutes: 30
i18nKey: "lesson.m1.w1.d2"
---

# Day 2 — Left hand, first steps: waking up four fingers
...
▶ **BPM 60.** Going up, lay the fingers on; coming down, lift them one by one. Downstrokes only is fine for now.
...
**27–30 min · Check**
Write down the BPM you reached, and if you like, record 30 seconds to hear whether all four notes are clear.

**Done when:** you can play 1-2-3-4 on the 6th string buzz-free and clear at 60.

## ④ Tips / common mistakes

- **Giving up on the pinky.** Substituting finger 3 because finger 4 won't press means it never improves. Slow but with the pinky, all the way through.
- **Laying the finger flat.** If you don't stand the fingertip up, the neighboring string rings and the sound gets messy. Use the plump part under the nail.
- **Pressing the middle of the fret.** Pressing the center takes twice the force. Aim just behind the fret.
- **Over-bending the wrist.** Bend the wrist too much and it soon aches. Start with your left thumb resting comfortably behind the neck.
