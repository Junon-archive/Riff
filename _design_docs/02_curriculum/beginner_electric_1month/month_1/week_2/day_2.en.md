---
title: "Crossing strings without a break — string crossing"
dayKey: "m1.w2.d2"
estMinutes: 30
i18nKey: "lesson.m1.w2.d2"
---

# Day 2 — Cross the string, keep the picking going
...
▶ **BPM 60.** Zigzag across 6-5-4. Only the right hand moves house; keep the arm fixed.
...
**Done when:** you can play a pattern crossing two or three strings at 60 with the alternate picking never breaking.

## ④ Tips / common mistakes

- **Crossing from the arm.** Swing the arm big and you scrape the next string and push the beat. Wrist in place, only the pick tip moves.
- **Stopping at the seam.** Stop the hand when the string changes and the beat pushes right there. Keep the alternate picking rolling.
- **Mixing up pick direction.** Without a fixed rule like down on the 6th, up on the 5th, you'll fumble every time. Carve the direction into your body.
- **Speed first.** Being unbroken at 60 comes first. Add speed after that.
