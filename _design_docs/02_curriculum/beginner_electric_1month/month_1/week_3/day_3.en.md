---
title: "Palm mute + downpicking — the chug groove"
dayKey: "m1.w3.d3"
estMinutes: 30
i18nKey: "lesson.m1.w3.d3"
---

# Day 3 — The chug groove
...
▶ BPM 90, downpicks. Chug low and palm-muted up front, then lift the palm off only the green E5 to let it ring wide — that one hit is the groove's period.
...
**Done when:** you can chug the palm-muted power-chord riff (steady eighth notes) at the target BPM 90 with even strength and length.

## ④ Tips / common mistakes

- **Palm too deep.** Cover too deep and the pitch vanishes into a dull "thud." Slide the palm back until a bit of pitch stays.
- **Mixing in upstrokes.** A palm-muted riff is downpicks by default. Only top-to-down keeps the sound heavy and even.
- **Chasing dynamics.** Sounding all eight chugs the same comes first. Accents wait until the evenness locks in.
- **Tensing the wrist.** The palm just rests; the right hand flicks lightly from the wrist. Tension in the arm stiffens you fast.
