...
**0–10 min · Warm-up**
Alternate G ↔ Gm every four beats. Only the 1st string 7↔6; the other three strings fixed. Keep the 6th & 5th muted.

**10–20 min · Brain training (today's target = top note 3↔b3)**
With **Example 1,** alternate the 1st string frets 7 and 6, saying "third / flat third." You pass when you can flip the top note bright (7) and dark (6) with eyes closed.

**20–40 min · Real comping (Example 2 / 76–86 BPM)**
**Repeat Example 2 at BPM 80 4×** (G↔Gm). Once comfortable, move the root to another fret (e.g., A = 7) and apply the same top-note switch. Feel that the top note drives the chord's impression.

**40–50 min · Record & reflect (recommended)**
Record 30 seconds of G↔Gm. Check: does the top note (1st string) change clearly, and do the low strings stay silent?
