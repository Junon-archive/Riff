...
先週はずっとルートが**6弦**にありました。今週はなぜその家を**5弦**へ移すかというと — ルート弦を1つ自由にするだけで、指板全体がぐっと開くからです。安心して、ルールは1つも変わりません。相変わらず「ルートの上に3度・5度を乗せる」です。ただルートが別の弦へ行くと、3度・5度も新しい場所へ付いて移るので、今日はその新しい地図を目に馴染ませる日です。
...
そして**6弦は使いません。** ここでAフォームの新しい習慣が1つ生まれます — **6弦を確実に殺すこと**。ルートより低い弦が漏れて鳴るとコードが濁ります。親指で軽く覆うか、ルートを押さえる指先で6弦に触れてミュートして。最初は気にすることが1つ増えたようでも、数日で手が勝手にやってくれます。
