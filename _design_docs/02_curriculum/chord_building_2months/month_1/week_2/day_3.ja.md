...
昨日2つのスイッチ（2弦の3度、3弦の7度）を学びました。まず両方下げて**Cm7**（b3＋b7）を完成させ、今日の新しい客**Maj7**を招きます。

カギは**3弦**。この弦が7度の「三差路」です：

- **3弦5フレット＝R**（オクターブルート）→ ただのメジャー/マイナー
- **3弦4フレット＝7**（長7度）→ **Maj7**
- **3弦3フレット＝b7**（短7度）→ **ドミナント7**

つまり**b7（3フレット）とMaj7の7（4フレット）はちょうど1フレット、半音差**。でもこの半音がまるで違う感情を作ります。b7（ドミナント）は「早く解決したい」緊張、Maj7の7は「浮遊した、幻想的で洗練された」未完。ジャズやシティポップのあの切ない色がまさにこのMaj7です。今日はこの2つを3弦で並べ、耳で聞き分けます。
