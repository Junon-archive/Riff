...
어제 두 스위치(2번 줄 3도, 3번 줄 7도)를 배웠죠. 오늘은 먼저 둘 다 내려 **Cm7**(b3 + b7)을 완성하고, 이번 주의 새 손님 **Maj7**을 초대합니다. 이름이 비슷해서 헷갈릴 것 같죠? 놀랍게도 자리는 딱 한 칸 차이예요.

핵심은 전부 **3번 줄**에 있어요. 이 줄이 7도의 '삼거리'거든요:
