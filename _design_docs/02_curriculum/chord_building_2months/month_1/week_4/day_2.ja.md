...
3週間使ってきた2つのスイッチ（3度・7度）がシェルでも生きています。ただ5度・重複音がないので、残った**2つの色の音だけ**をくっきり操作するわけです。複雑に見えますか？　でも覚えるのはたった2つ — 「7度の弦」と「3度の弦」だけ。この2つのスイッチさえ手に馴染めば、メジャー・ドミナント・マイナーを指1本で行き来できます。コードを3つ覚えるのではなく、スイッチを2つ学ぶんです。
