...
6弦シェル（昨日）が4・3弦なら、5弦シェルは**3・2弦**。ルート弦が変わると色の音も1セット上へ移動します。昨日と原理はまったく同じなので、新しく覚える負担はほとんどありません。**ルートが1弦下がれば、色の音も1弦ずつ下へついてくる** — この1つのルールで十分です。この2セット（6弦・5弦）が揃えば、明日II-V-Iを全部シェルでつなげます。今日で、コードのルートが5弦でも6弦でもシェルで押さえられるようになります。
