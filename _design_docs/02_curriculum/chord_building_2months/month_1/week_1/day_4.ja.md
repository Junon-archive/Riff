...
今週のゴールです。ここまで学んだ2つのスイッチを合体させます。

- **3弦＝3度スイッチ。** 4フレット（3、明るい）↔ 3フレット（b3、暗い）。
- **4弦＝7度スイッチ。** 5フレット（R）↔ 3フレット（b7、緊張）。

今日の新しいコード**m7**は、この2つのスイッチを**両方下げた**状態。つまりマイナー（b3）にドミナントのb7まで乗せたもの。Gなら3弦3フレット（b3）＋4弦3フレット（b7）＝**Gm7**。暗いけれど緊張がやわらかくほどけた、ジャズ・ソウルのあの洗練された色です。

2つのスイッチを表で見ると、ちょうど4マスになります：
...
4つのコードは**指2本の上下の組み合わせ**にすぎません。今日はこれを1つのルート上で自由に循環します。
